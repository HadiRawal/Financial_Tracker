...
SECRET_KEY = 'django-insecure-$x$2_cqcvg)go4tw7ed-%^lyno2y3vhd6)w%7ota^eyi8xij(@'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'Financial_Tracker/static')]
...
EMAIL_PORT = 587
EMAIL_HOST_PASSWORD = 'wbed udvi clnc jabj'